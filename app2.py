...
from leaderboard_db import init_db, submit_score, top_scores, submit_feedback, list_feedback
...
st.caption("Discover the language hidden inside language.")
    ...
    if ai_generation_available():
        ...
        if st.button(
            ...
            try:
                ...
                replace_game("Practice", custom, configured_min, require_english, signature)
